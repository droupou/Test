...
private:	// User declarations
    ...
    __fastcall TOutputFrm(TComponent* Owner);    void __fastcall TOutputFrm::AddLabel(String header, String title, String title2, String Material, String PDate, String EDate, String Enter, bool Is_Approved, String Approve, String Artist, String Dimension, String Pic);
