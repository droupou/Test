...
__published:	// IDE-managed Components    TMainMenu *MainMenu1;
    ...
    TMenuItem *EditUser1;
    TMenuItem *EditPeriodDate1;
    TMenuItem *EditMaterials1;
    TMenuItem *Add1;
    TMenuItem *Edit1;
    ...
    void __fastcall EditPeriodDate1Click(TObject *Sender);
    void __fastcall EditMaterials1Click(TObject *Sender);
