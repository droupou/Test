<?php /* Smarty version 2.6.16, created on 2008-01-30 07:59:28
...
<?php if ($this->_tpl_vars['ItemEditRotateAndScalePhoto']['editPhoto']['can']['resize']):  echo $this->_reg_objects['g'][0]->dimensions(array('formVar' => "form[resize]",'width' => $this->_tpl_vars['form']['resize']['width'],'height' => $this->_tpl_vars['form']['resize']['height']), $this);?>
...
<?php endif;  if (! empty ( $this->_tpl_vars['form']['error']['resize']['size']['missing'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => 'You must enter a size'), $this);?>

</div>
<?php endif;  if (! empty ( $this->_tpl_vars['form']['error']['resize']['size']['invalid'] )): ?>
<div class="giError">
...
unset($_smarty_tpl_vars);
  endforeach; endif; unset($_from);  if ($this->_tpl_vars['ItemEditRotateAndScalePhoto']['editPhoto']['can']['rotate'] || $this->_tpl_vars['ItemEditRotateAndScalePhoto']['editPhoto']['can']['resize']): ?>
<div class="gbBlock">
