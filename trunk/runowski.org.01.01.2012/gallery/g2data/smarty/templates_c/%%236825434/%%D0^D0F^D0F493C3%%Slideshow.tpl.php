<?php /* Smarty version 2.6.16, created on 2008-01-15 11:35:55
         compiled from gallery:modules/slideshow/templates/Slideshow.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'markup', 'gallery:modules/slideshow/templates/Slideshow.tpl', 23, false),)), $this); ?>
...
<?php else:  $_from = $this->_tpl_vars['SlideShow']['itemList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
">
<?php ob_start();  echo $this->_reg_objects['g'][0]->date(array('timestamp' => $this->_tpl_vars['it']['data']['originationTimestamp']), $this); $this->_smarty_vars['capture']['date'] = ob_get_contents(); ob_end_clean();  echo $this->_reg_objects['g'][0]->text(array('text' => "Date: %s",'arg1' => $this->_smarty_vars['capture']['date']), $this);?>
...
<option value="1"><?php echo $this->_reg_objects['g'][0]->text(array('text' => '1 second'), $this);?>
</option>
