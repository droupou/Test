<?php /* Smarty version 2.6.16, created on 2008-01-08 07:59:58
         compiled from gallery:modules/keyalbum/templates/KeywordAlbumSiteAdmin.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gallery:modules/keyalbum/templates/KeywordAlbumSiteAdmin.tpl', 31, false),)), $this); ?>
...
<?php ob_start();  echo $this->_reg_objects['g'][0]->text(array('text' => "Settings for %s theme in Keyword Albums",'arg1' => $this->_tpl_vars['ThemeSettingsForm']['theme']['name']), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('message', ob_get_contents());ob_end_clean();  echo $this->_reg_objects['g'][0]->block(array('type' => "core.ThemeSettingsForm",'class' => 'gbBlock','message' => $this->_tpl_vars['message'],'formId' => 'siteAdminForm'), $this);?>
