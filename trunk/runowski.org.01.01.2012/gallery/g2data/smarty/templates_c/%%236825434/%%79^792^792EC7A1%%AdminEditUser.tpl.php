<?php /* Smarty version 2.6.16, created on 2008-01-08 07:53:14
         compiled from gallery:modules/core/templates/AdminEditUser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gallery:modules/core/templates/AdminEditUser.tpl', 51, false),)), $this); ?>
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['userName']['missing'] )): ?>
<div class="giError">
...
<?php endif;  endif;  if ($this->_tpl_vars['AdminEditUser']['show']['language']): ?>
...
<?php endif;  if ($this->_tpl_vars['AdminEditUser']['show']['password']): ?>
<h4>
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['password2']['mismatch'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => 'The passwords you entered did not match'), $this);?>

</div>
<?php endif;  endif;  if ($this->_tpl_vars['AdminEditUser']['show']['locked'] || $this->_tpl_vars['AdminEditUser']['failedLoginCount']): ?>
...
<?php endif;  if ($this->_tpl_vars['AdminEditUser']['failedLoginCount']): ?>
<p>
