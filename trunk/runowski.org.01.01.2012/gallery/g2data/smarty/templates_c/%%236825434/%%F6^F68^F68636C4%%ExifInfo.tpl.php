...
<?php if (empty ( $this->_tpl_vars['item'] )): ?> <?php $this->assign('item', $this->_tpl_vars['theme']['item']); ?> <?php endif;  echo $this->_reg_objects['g'][0]->callback(array('type' => "exif.LoadExifInfo",'itemId' => $this->_tpl_vars['item']['id']), $this);?>
...
<div>
<?php if (( $this->_tpl_vars['block']['exif']['LoadExifInfo']['mode'] == 'summary' )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'summary'), $this);?>
...
<?php endif;  if (( $this->_tpl_vars['block']['exif']['LoadExifInfo']['mode'] == 'detailed' )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'details'), $this);?>
...
<?php endif;  if (! empty ( $this->_tpl_vars['block']['exif']['LoadExifInfo']['exifData'] )): ?>
