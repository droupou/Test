<?php /* Smarty version 2.6.16, created on 2008-01-11 12:15:22
         compiled from gallery:modules/core/templates/ItemMove.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'gallery:modules/core/templates/ItemMove.tpl', 138, false),array('modifier', 'repeat', 'gallery:modules/core/templates/ItemMove.tpl', 224, false),)), $this); ?>
...
<?php if (( $this->_tpl_vars['ItemMove']['numPages'] > 1 )):  echo $this->_reg_objects['g'][0]->text(array('text' => "(page %d of %d)",'arg1' => $this->_tpl_vars['ItemMove']['page'],'arg2' => $this->_tpl_vars['ItemMove']['numPages']), $this);?>
...
'].disabled = 0;
<?php endforeach; endif; unset($_from);  $_from = $this->_tpl_vars['ItemMove']['peerTypes']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['unused']):
?>
form.elements['<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[selectedIds][".($this->_tpl_vars['id'])."]"), $this);?>
'].disabled = 0;
...
form.elements['<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[selectedIds][".($this->_tpl_vars['id'])."]"), $this);?>
'].disabled = 1;
<?php endforeach; endif; unset($_from);  $_from = $this->_tpl_vars['ItemMove']['peerTypes']['album']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['unused']):
?>
form.elements['<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[selectedIds][".($this->_tpl_vars['id'])."]"), $this);?>
'].disabled = 0;
...
<?php $_from = $this->_tpl_vars['ItemMove']['peers']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['peer']):
 $this->assign('peerItemId', $this->_tpl_vars['peer']['id']); ?>
<tr>
<td align="center">
...
<i>
<?php if (isset ( $this->_tpl_vars['ItemMove']['peerTypes']['data'][$this->_tpl_vars['peerItemId']] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "(data)"), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['ItemMove']['peerTypes']['album'][$this->_tpl_vars['peerItemId']] )):  if (isset ( $this->_tpl_vars['ItemMove']['peerDescendentCounts'][$this->_tpl_vars['peerItemId']] )):  echo $this->_reg_objects['g'][0]->text(array('one' => "(album containing %d item)",'many' => "(album containing %d items)",'count' => $this->_tpl_vars['ItemMove']['peerDescendentCounts'][$this->_tpl_vars['peerItemId']],'arg1' => $this->_tpl_vars['ItemMove']['peerDescendentCounts'][$this->_tpl_vars['peerItemId']]), $this);?>
...
<?php endif;  if (! empty ( $this->_tpl_vars['form']['error']['source'][$this->_tpl_vars['peerItemId']]['permission']['addAlbumItem'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => "You are not allowed to move an album to the chosen destination."), $this);?>
<br/>
</div>
<?php endif;  if (! empty ( $this->_tpl_vars['form']['error']['source'][$this->_tpl_vars['peerItemId']]['permission']['addDataItem'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => "You are not allowed to move an item to the chosen destination."), $this);?>
<br/>
</div>
<?php endif;  if (! empty ( $this->_tpl_vars['form']['error']['source'][$this->_tpl_vars['peerItemId']]['selfMove'] )): ?>
<div class="giError">
...
"/>
<?php endif;  if (( $this->_tpl_vars['ItemMove']['page'] < $this->_tpl_vars['ItemMove']['numPages'] )): ?>
<input type="submit" class="inputTypeSubmit"
...
<?php endif;  if (! empty ( $this->_tpl_vars['form']['error']['destination']['empty'] )): ?>
<div class="giError">
