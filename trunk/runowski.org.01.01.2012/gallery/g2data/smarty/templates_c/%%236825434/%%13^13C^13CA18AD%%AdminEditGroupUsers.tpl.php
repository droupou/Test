...
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'gallery:modules/core/templates/AdminEditGroupUsers.tpl', 67, false),)), $this); ?>
...
<h3 class="giSuccess">
<?php if (isset ( $this->_tpl_vars['status']['addedUser'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Added user '%s' to group '%s'",'arg1' => $this->_tpl_vars['status']['addedUser'],'arg2' => $this->_tpl_vars['AdminEditGroupUsers']['group']['groupName']), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['removedUser'] )):  echo $this->_reg_objects['g'][0]->text(array('one' => "Removed user '%s' from group '%s'",'many' => "Removed %s users from group '%s'",'count' => $this->_tpl_vars['status']['removedUsers'],'arg1' => $this->_tpl_vars['status']['removedUser'],'arg2' => $this->_tpl_vars['AdminEditGroupUsers']['group']['groupName']), $this);?>
...
<?php endif;  if ($this->_tpl_vars['AdminEditGroupUsers']['canRemove']): ?>
<div>
<input type="submit" class="inputTypeSubmit"
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['list']['noUserSelected'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => "You must select a user to remove."), $this);?>

</div>
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['list']['cantRemoveSelf'] )): ?>
<div class="giError">
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['userName']['invalid'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => "User '%s' does not exist.",'arg1' => $this->_tpl_vars['form']['text']['userName']), $this);?>

</div>
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['userName']['alreadyInGroup'] )): ?>
<div class="giError">
