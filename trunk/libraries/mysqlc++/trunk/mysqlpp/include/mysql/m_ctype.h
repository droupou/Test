...
extern CHARSET_INFO *find_compiled_charset(uint8 cs_number);
extern CHARSET_INFO *get_charset(uint8 cs_number);

/* mysys/charset.c */
extern uint8         get_charset_number(const char *charset_name);
extern my_bool       set_default_charset(uint8 cs);
extern const char    *get_charset_name(uint8 charset_number);
